...
/**
 * Get priority on Headsail PLIC works the same way as the RISC-V PLIC spec.
 */
...
/**
 * Set priority on Headsail PLIC works the same way as the RISC-V PLIC spec.
 */
...
/**
 * THRESHOLD DOES NOT WORK THE SAME WAY!
 */
...
/**
 * Interrupt Enable on Headsail PLIC works the same way as the RISC-V PLIC spec.
 */
