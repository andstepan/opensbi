...
# PLATFORM_RISCV_ISA = rv64imac_zicsr
...
FW_FDT_PATH=/home/andreas-stergiopoulos/SoCHub/u-boot/arch/riscv/dts/headsail_hpc.dtb
...
# defined
ifeq ($(PLATFORM_RISCV_XLEN), 32)
FW_JUMP_ADDR=0x100400000
else
FW_JUMP_ADDR=0x100200000
endif
FW_JUMP_FDT_ADDR=0x100B00000
...
FW_PAYLOAD_OFFSET=0xA00000
endif
FW_PAYLOAD_FDT_OFFSET=0xB00000
